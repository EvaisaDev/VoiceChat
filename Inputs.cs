...
namespace Evaisa.VoiceChat
{
    ...
    internal static class Inputs
    {
        ...
        {
            new ActionDef() { id = 350, actionName = "PushToTalkKeyboard", token = "Push To Talk", actionType = InputActionType.Button, hasPosAndNeg = false, joystickMap = ControllerInput.None, keyboardMap = KeyboardKeyCode.X },
            new ActionDef() { id = 351, actionName = "PushToTalkController", token = "Push To Talk", actionType = InputActionType.Button, hasPosAndNeg = false, joystickMap = ControllerInput.DPadRight, keyboardMap = KeyboardKeyCode.None }
        };
